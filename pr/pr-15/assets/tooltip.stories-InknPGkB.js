import{r as St,D as bt,b as a,A as Y,w as nt}from"./iframe-DPGxgCSO.js";import"./preload-helper-PPVm8Dsz.js";let Z,ft=0;function dt(t){Z=t}function pt(){Z=null,ft=0}function Tt(){return ft++}const K=Symbol("haunted.phase"),Q=Symbol("haunted.hook"),ut=Symbol("haunted.update"),ht=Symbol("haunted.commit"),$=Symbol("haunted.effects"),B=Symbol("haunted.layoutEffects"),et="haunted.context";class kt{update;host;virtual;[Q];[$];[B];constructor(e,o){this.update=e,this.host=o,this[Q]=new Map,this[$]=[],this[B]=[]}run(e){dt(this);let o=e();return pt(),o}_runEffects(e){let o=this[e];dt(this);for(let n of o)n.call(this);pt()}runEffects(){this._runEffects($)}runLayoutEffects(){this._runEffects(B)}teardown(){this[Q].forEach(o=>{typeof o.teardown=="function"&&o.teardown(!0)})}}const _t=Promise.resolve().then.bind(Promise.resolve());function yt(){let t=[],e;function o(){e=null;let n=t;t=[];for(var s=0,i=n.length;s<i;s++)n[s]()}return function(n){t.push(n),e==null&&(e=_t(o))}}const Et=yt(),mt=yt();class Ct{renderer;host;state;[K];_updateQueued;_active;constructor(e,o){this.renderer=e,this.host=o,this.state=new kt(this.update.bind(this),o),this[K]=null,this._updateQueued=!1,this._active=!0}update(){this._active&&(this._updateQueued||(Et(()=>{let e=this.handlePhase(ut);mt(()=>{this.handlePhase(ht,e),mt(()=>{this.handlePhase($)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,o){switch(this[K]=e,e){case ht:this.commit(o),this.runEffects(B);return;case ut:return this.render();case $:return this.runEffects($)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const st=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},At=t=>t?.map(e=>typeof e=="string"?st(e):e),Bt=(t,...e)=>t.flatMap((o,n)=>[o,e[n]||""]).join(""),_=Bt,Pt=(t="")=>t.replace(/-+([a-z])?/g,(e,o)=>o?o.toUpperCase():"");function Rt(t){class e extends Ct{frag;renderResult;constructor(s,i,h){super(s,h||i),this.frag=i}commit(s){this.renderResult=t(s,this.frag)}}function o(n,s,i){const h=(i||s||{}).baseElement||HTMLElement,{observedAttributes:b=[],useShadowDOM:m=!0,shadowRootInit:x={},styleSheets:d}=i||s||{},z=At(n.styleSheets||d);class c extends h{_scheduler;static get observedAttributes(){return n.observedAttributes||b||[]}constructor(){if(super(),m===!1)this._scheduler=new e(n,this);else{const r=this.attachShadow({mode:"open",...x});z&&(r.adoptedStyleSheets=z),this._scheduler=new e(n,r,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(r,v,p){if(v===p)return;let u=p===""?!0:p;Reflect.set(this,Pt(r),u)}}function f(l){let r=l,v=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return r},set(p){v&&r===p||(v=!0,r=p,this._scheduler&&this._scheduler.update())}})}const g=new Proxy(h.prototype,{getPrototypeOf(l){return l},set(l,r,v,p){let u;return r in l?(u=Object.getOwnPropertyDescriptor(l,r),u&&u.set?(u.set.call(p,v),!0):(Reflect.set(l,r,v,p),!0)):(typeof r=="symbol"||r[0]==="_"?u={enumerable:!0,configurable:!0,writable:!0,value:v}:u=f(v),Object.defineProperty(p,r,u),u.set&&u.set.call(p,v),!0)}});return Object.setPrototypeOf(c.prototype,g),c}return o}class E{id;state;constructor(e,o){this.id=e,this.state=o}}function Ht(t,...e){let o=Tt(),n=Z[Q],s=n.get(o);return s||(s=new t(o,Z,...e),n.set(o,s)),s.update(...e)}function C(t){return Ht.bind(null,t)}function zt(t){return C(class extends E{callback;lastValues;values;_teardown;constructor(e,o,n,s){super(e,o),t(o,this)}update(e,o){this.callback=e,this.values=o}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,o)=>this.lastValues[o]!==e)}})}function wt(t,e){t[$].push(e)}const T=zt(wt),Ft=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,Ot=C(class extends E{Context;value;_ranEffect;_unsubscribe;constructor(t,e,o){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,wt(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};Ft(this.state.host).dispatchEvent(new CustomEvent(et,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:n=null,value:s}=e;this.value=n?s:t.defaultValue,this._unsubscribe=n}teardown(){this._unsubscribe&&this._unsubscribe()}});function Lt(t){return e=>{const o={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(et,this)}disconnectedCallback(){this.removeEventListener(et,this)}handleEvent(n){const{detail:s}=n;s.Context===o&&(s.value=this.value,s.unsubscribe=this.unsubscribe.bind(this,s.callback),this.listeners.add(s.callback),n.stopPropagation())}unsubscribe(n){this.listeners.delete(n)}set value(n){this._value=n;for(let s of this.listeners)s(n)}get value(){return this._value}},Consumer:t(function({render:n}){const s=Ot(o);return n(s)},{useShadowDOM:!1}),defaultValue:e};return o}}const xt=C(class extends E{value;values;constructor(t,e,o,n){super(t,e),this.value=o(),this.values=n}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,o)=>this.values[o]!==e)}}),gt=(t,e)=>xt(()=>t,e);function Mt(t,e){t[B].push(e)}zt(Mt);const Dt=C(class extends E{args;constructor(t,e,o){super(t,e),this.updater=this.updater.bind(this),typeof o=="function"&&(o=o()),this.makeArgs(o)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}});C(class extends E{reducer;currentState;constructor(t,e,o,n,s){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=s!==void 0?s(n):n}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}});const Nt=/([A-Z])/gu;C(class extends E{property;eventName;constructor(t,e,o,n){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=o,this.eventName=o.replace(Nt,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof n=="function"&&(n=n()),n!=null&&this.updateProp(n))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}});function W(t){return xt(()=>({current:t}),[])}function It({render:t}){const e=Rt(t),o=Lt(e);return{component:e,createContext:o}}const jt={CHILD:2},Vt=t=>(...e)=>({_$litDirective$:t,values:e});class Gt{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,o,n){this._$Ct=e,this._$AM=o,this._$Ci=n}_$AS(e,o){return this.update(e,o)}update(e,o){return this.render(...o)}}const P=(t,e)=>{const o=t._$AN;if(o===void 0)return!1;for(const n of o)n._$AO?.(e,!1),P(n,e);return!0},J=t=>{let e,o;do{if((e=t._$AM)===void 0)break;o=e._$AN,o.delete(t),t=e}while(o?.size===0)},$t=t=>{for(let e;e=t._$AM;t=e){let o=e._$AN;if(o===void 0)e._$AN=o=new Set;else if(o.has(t))break;o.add(t),Qt(e)}};function Ut(t){this._$AN!==void 0?(J(this),this._$AM=t,$t(this)):this._$AM=t}function qt(t,e=!1,o=0){const n=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(e)if(Array.isArray(n))for(let i=o;i<n.length;i++)P(n[i],!1),J(n[i]);else n!=null&&(P(n,!1),J(n));else P(this,t)}const Qt=t=>{t.type==jt.CHILD&&(t._$AP??=qt,t._$AQ??=Ut)};class Wt extends Gt{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,o,n){super._$AT(e,o,n),$t(this),this.isConnected=e._$AU}_$AO(e,o=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),o&&(P(this,e),J(this))}setValue(e){if(St(this._$Ct))this._$Ct._$AI(e,this);else{const o=[...this._$Ct._$AH];o[this._$Ci]=e,this._$Ct._$AI(o,this,0)}}disconnected(){}reconnected(){}}const{component:it}=It({render:bt}),at=st(_`
	/*
...
`,Jt=["variant","size","disabled","full-width","type"],Kt=t=>{const e=t.hasAttribute("disabled"),o=t.getAttribute("type")||"button";return a`
		<button type=${o} class="button" ?disabled=${e} part="button">
			<slot name="prefix"></slot>
			<slot></slot>
			<slot name="suffix"></slot>
		</button>
	`};customElements.define("cosmoz-button",it(Kt,{observedAttributes:Jt,styleSheets:[at,Zt],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const k=t=>t??Y;function S(t,e,o){return t?e(t):o?.(t)}const Xt=({slot:t,title:e,className:o,width:n="24",height:s="24",styles:i}={})=>a`
  <svg
    slot=${k(t)}
...
`,te=({slot:t,title:e,className:o,width:n="24",height:s="24",styles:i}={})=>a`
  <svg
    slot=${k(t)}
...
`;customElements.define("cosmoz-tooltip-content",it(()=>a`
			...
			<slot></slot>
		`,{styleSheets:[at,oe]}));const ot=st(_`
...
`),vt=(t,e,o)=>bt(a`<cosmoz-tooltip-content>
		...
		</cosmoz-tooltip-content>`,t),ne=(t,e)=>{const{for:o,heading:n,description:s,placement:i="top",delay:h=300,disabled:b=!1}=e,m=W(),x=!!(n||s);T(()=>{if(!o||!x)return;const d=t.getRootNode(),z=d.adoptedStyleSheets??[];z.includes(ot)||(d.adoptedStyleSheets=[...z,ot]);const c=document.createElement("div");c.setAttribute("popover","manual"),c.setAttribute("role","tooltip"),c.classList.add("cosmoz-tooltip-popover"),t.after(c),m.current=c,vt(c,n,s);const f=`[name="${o}"]`,g=`--tooltip-anchor-${o}`;let l;const r=y=>{b||(clearTimeout(l),y.style.anchorName=g,c.style.positionAnchor=g,c.style.positionArea=i,l=window.setTimeout(()=>c.showPopover(),h))},v=()=>{clearTimeout(l),c.hidePopover()},p=y=>{const w=y.target.closest?.(f);w&&r(w)},u=y=>{const w=y.target.closest?.(f);if(!w)return;const lt=y.relatedTarget;lt&&w.contains(lt)||v()},rt=y=>{const w=y.target.closest?.(f);w&&r(w)},ct=y=>{y.target.closest?.(f)&&v()};return d.addEventListener("pointerover",p),d.addEventListener("pointerout",u),d.addEventListener("focusin",rt),d.addEventListener("focusout",ct),()=>{clearTimeout(l),d.removeEventListener("pointerover",p),d.removeEventListener("pointerout",u),d.removeEventListener("focusin",rt),d.removeEventListener("focusout",ct),c.hidePopover(),c.remove(),m.current=void 0}},[o,i,h,b,x]),T(()=>{!o||!m.current||vt(m.current,n,s)},[n,s,o]),T(()=>{!b||!m.current||m.current.hidePopover()},[b])},se=t=>{const[e,o]=Dt(!1);return T(()=>{const n=t.current;if(!n)return;const s=()=>{o(n.assignedElements().length>0)};return s(),n.addEventListener("slotchange",s),()=>n.removeEventListener("slotchange",s)},[t.current]),e},ie=_`
	:host {
...
`,ae=t=>{const{heading:e,description:o,for:n,placement:s="top",delay:i=300,disabled:h=!1}=t,b=W(),m=W(),x=W(),d=se(x),z=!!(e||o||d),c=gt(()=>{h||!z||(clearTimeout(m.current),m.current=window.setTimeout(()=>{b.current?.showPopover()},i))},[i,h,z]);T(()=>{h&&(clearTimeout(m.current),b.current?.hidePopover())},[h]);const f=gt(()=>{clearTimeout(m.current),b.current?.hidePopover()},[]);return T(()=>{if(n)return;const g=l=>{const r=l.relatedTarget;r&&t.contains(r)||f()};return t.addEventListener("pointerover",c),t.addEventListener("pointerout",g),()=>{t.removeEventListener("pointerover",c),t.removeEventListener("pointerout",g)}},[n,c,f]),ne(t,{for:n,heading:e,description:o,placement:s,delay:i,disabled:h}),n?Y:z?a`
		<slot @focusin=${c} @focusout=${f}></slot>
		<div
...
}`,...q.parameters?.docs?.source}}};const pe=["Basic","HeadingOnly","DescriptionOnly","ForAttribute","Placements","CustomDelay","CustomContent","OnLinks","FocusWithoutHover","ForAttributeFocusWithoutHover","OnIcons","Disabled","DisabledForAttribute","EmptyPassthrough"];export{R as Basic,D as CustomContent,M as CustomDelay,F as DescriptionOnly,G as Disabled,U as DisabledForAttribute,q as EmptyPassthrough,I as FocusWithoutHover,O as ForAttribute,j as ForAttributeFocusWithoutHover,H as HeadingOnly,V as OnIcons,N as OnLinks,L as Placements,pe as __namedExportsOrder,de as default};
