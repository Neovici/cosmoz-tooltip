import{r as zt,D as mt,b as a,A as q,w as et}from"./iframe-C9lcbKa0.js";import"./preload-helper-PPVm8Dsz.js";let Q,vt=0;function rt(t){Q=t}function ct(){Q=null,vt=0}function xt(){return vt++}const W=Symbol("haunted.phase"),U=Symbol("haunted.hook"),lt=Symbol("haunted.update"),dt=Symbol("haunted.commit"),z=Symbol("haunted.effects"),E=Symbol("haunted.layoutEffects"),Z="haunted.context";class $t{update;host;virtual;[U];[z];[E];constructor(e,o){this.update=e,this.host=o,this[U]=new Map,this[z]=[],this[E]=[]}run(e){rt(this);let o=e();return ct(),o}_runEffects(e){let o=this[e];rt(this);for(let n of o)n.call(this);ct()}runEffects(){this._runEffects(z)}runLayoutEffects(){this._runEffects(E)}teardown(){this[U].forEach(o=>{typeof o.teardown=="function"&&o.teardown(!0)})}}const St=Promise.resolve().then.bind(Promise.resolve());function gt(){let t=[],e;function o(){e=null;let n=t;t=[];for(var s=0,i=n.length;s<i;s++)n[s]()}return function(n){t.push(n),e==null&&(e=St(o))}}const kt=gt(),pt=gt();class Tt{renderer;host;state;[W];_updateQueued;_active;constructor(e,o){this.renderer=e,this.host=o,this.state=new $t(this.update.bind(this),o),this[W]=null,this._updateQueued=!1,this._active=!0}update(){this._active&&(this._updateQueued||(kt(()=>{let e=this.handlePhase(lt);pt(()=>{this.handlePhase(dt,e),pt(()=>{this.handlePhase(z)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,o){switch(this[W]=e,e){case dt:this.commit(o),this.runEffects(E);return;case lt:return this.render();case z:return this.runEffects(z)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const ot=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},_t=t=>t?.map(e=>typeof e=="string"?ot(e):e),Et=(t,...e)=>t.flatMap((o,n)=>[o,e[n]||""]).join(""),k=Et,At=(t="")=>t.replace(/-+([a-z])?/g,(e,o)=>o?o.toUpperCase():"");function Ct(t){class e extends Tt{frag;renderResult;constructor(s,i,v){super(s,v||i),this.frag=i}commit(s){this.renderResult=t(s,this.frag)}}function o(n,s,i){const v=(i||s||{}).baseElement||HTMLElement,{observedAttributes:g=[],useShadowDOM:r=!0,shadowRootInit:y={},styleSheets:c}=i||s||{},b=_t(n.styleSheets||c);class w extends v{_scheduler;static get observedAttributes(){return n.observedAttributes||g||[]}constructor(){if(super(),r===!1)this._scheduler=new e(n,this);else{const l=this.attachShadow({mode:"open",...y});b&&(l.adoptedStyleSheets=b),this._scheduler=new e(n,l,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(l,u,d){if(u===d)return;let p=d===""?!0:d;Reflect.set(this,At(l),p)}}function $(h){let l=h,u=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return l},set(d){u&&l===d||(u=!0,l=d,this._scheduler&&this._scheduler.update())}})}const B=new Proxy(v.prototype,{getPrototypeOf(h){return h},set(h,l,u,d){let p;return l in h?(p=Object.getOwnPropertyDescriptor(h,l),p&&p.set?(p.set.call(d,u),!0):(Reflect.set(h,l,u,d),!0)):(typeof l=="symbol"||l[0]==="_"?p={enumerable:!0,configurable:!0,writable:!0,value:u}:p=$(u),Object.defineProperty(d,l,p),p.set&&p.set.call(d,u),!0)}});return Object.setPrototypeOf(w.prototype,B),w}return o}class T{id;state;constructor(e,o){this.id=e,this.state=o}}function Bt(t,...e){let o=xt(),n=Q[U],s=n.get(o);return s||(s=new t(o,Q,...e),n.set(o,s)),s.update(...e)}function _(t){return Bt.bind(null,t)}function bt(t){return _(class extends T{callback;lastValues;values;_teardown;constructor(e,o,n,s){super(e,o),t(o,this)}update(e,o){this.callback=e,this.values=o}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,o)=>this.lastValues[o]!==e)}})}function ft(t,e){t[z].push(e)}const J=bt(ft),Pt=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,Ft=_(class extends T{Context;value;_ranEffect;_unsubscribe;constructor(t,e,o){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,ft(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};Pt(this.state.host).dispatchEvent(new CustomEvent(Z,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:n=null,value:s}=e;this.value=n?s:t.defaultValue,this._unsubscribe=n}teardown(){this._unsubscribe&&this._unsubscribe()}});function Ht(t){return e=>{const o={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(Z,this)}disconnectedCallback(){this.removeEventListener(Z,this)}handleEvent(n){const{detail:s}=n;s.Context===o&&(s.value=this.value,s.unsubscribe=this.unsubscribe.bind(this,s.callback),this.listeners.add(s.callback),n.stopPropagation())}unsubscribe(n){this.listeners.delete(n)}set value(n){this._value=n;for(let s of this.listeners)s(n)}get value(){return this._value}},Consumer:t(function({render:n}){const s=Ft(o);return n(s)},{useShadowDOM:!1}),defaultValue:e};return o}}const yt=_(class extends T{value;values;constructor(t,e,o,n){super(t,e),this.value=o(),this.values=n}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,o)=>this.values[o]!==e)}}),ut=(t,e)=>yt(()=>t,e);function Rt(t,e){t[E].push(e)}bt(Rt);_(class extends T{args;constructor(t,e,o){super(t,e),this.updater=this.updater.bind(this),typeof o=="function"&&(o=o()),this.makeArgs(o)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}});_(class extends T{reducer;currentState;constructor(t,e,o,n,s){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=s!==void 0?s(n):n}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}});const Lt=/([A-Z])/gu;_(class extends T{property;eventName;constructor(t,e,o,n){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=o,this.eventName=o.replace(Lt,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof n=="function"&&(n=n()),n!=null&&this.updateProp(n))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}});function X(t){return yt(()=>({current:t}),[])}function Ot({render:t}){const e=Ct(t),o=Ht(e);return{component:e,createContext:o}}const Mt={CHILD:2},It=t=>(...e)=>({_$litDirective$:t,values:e});class Nt{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,o,n){this._$Ct=e,this._$AM=o,this._$Ci=n}_$AS(e,o){return this.update(e,o)}update(e,o){return this.render(...o)}}const A=(t,e)=>{const o=t._$AN;if(o===void 0)return!1;for(const n of o)n._$AO?.(e,!1),A(n,e);return!0},Y=t=>{let e,o;do{if((e=t._$AM)===void 0)break;o=e._$AN,o.delete(t),t=e}while(o?.size===0)},wt=t=>{for(let e;e=t._$AM;t=e){let o=e._$AN;if(o===void 0)e._$AN=o=new Set;else if(o.has(t))break;o.add(t),Vt(e)}};function Dt(t){this._$AN!==void 0?(Y(this),this._$AM=t,wt(this)):this._$AM=t}function jt(t,e=!1,o=0){const n=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(e)if(Array.isArray(n))for(let i=o;i<n.length;i++)A(n[i],!1),Y(n[i]);else n!=null&&(A(n,!1),Y(n));else A(this,t)}const Vt=t=>{t.type==Mt.CHILD&&(t._$AP??=jt,t._$AQ??=Dt)};class Gt extends Nt{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,o,n){super._$AT(e,o,n),wt(this),this.isConnected=e._$AU}_$AO(e,o=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),o&&(A(this,e),Y(this))}setValue(e){if(zt(this._$Ct))this._$Ct._$AI(e,this);else{const o=[...this._$Ct._$AH];o[this._$Ci]=e,this._$Ct._$AI(o,this,0)}}disconnected(){}reconnected(){}}const{component:nt}=Ot({render:mt}),st=ot(k`
	/*
...
`,Qt=["variant","size","disabled","full-width","type"],Yt=t=>{const e=t.hasAttribute("disabled"),o=t.getAttribute("type")||"button";return a`
		<button type=${o} class="button" ?disabled=${e} part="button">
			<slot name="prefix"></slot>
			<slot></slot>
			<slot name="suffix"></slot>
		</button>
	`};customElements.define("cosmoz-button",nt(Yt,{observedAttributes:Qt,styleSheets:[st,qt],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const S=t=>t??q;function x(t,e,o){return t?e(t):o?.(t)}const Wt=({slot:t,title:e,className:o,width:n="24",height:s="24",styles:i}={})=>a`
  <svg
    slot=${S(t)}
...
`,Kt=({slot:t,title:e,className:o,width:n="24",height:s="24",styles:i}={})=>a`
  <svg
    slot=${S(t)}
...
`),ht=(t,e,o)=>mt(a`<cosmoz-tooltip-content>
		...
		</cosmoz-tooltip-content>`,t),te=(t,e)=>{const{for:o,heading:n,description:s,placement:i="top",delay:v=300}=e,g=X();J(()=>{if(!o)return;const r=t.getRootNode(),y=r.adoptedStyleSheets??[];y.includes(tt)||(r.adoptedStyleSheets=[...y,tt]);const c=document.createElement("div");c.setAttribute("popover","manual"),c.setAttribute("role","tooltip"),c.classList.add("cosmoz-tooltip-popover"),t.after(c),g.current=c,ht(c,n,s);const b=`[name="${o}"]`,w=`--tooltip-anchor-${o}`;let $;const B=m=>{clearTimeout($),m.style.anchorName=w,c.style.positionAnchor=w,c.style.positionArea=i,$=window.setTimeout(()=>c.showPopover(),v)},h=()=>{clearTimeout($),c.hidePopover()},l=m=>{const f=m.target.closest?.(b);f&&B(f)},u=m=>{const f=m.target.closest?.(b);if(!f)return;const at=m.relatedTarget;at&&f.contains(at)||h()},d=m=>{const f=m.target.closest?.(b);f&&B(f)},p=m=>{m.target.closest?.(b)&&h()},it=m=>{m.target.closest?.(b)&&h()};return r.addEventListener("pointerover",l),r.addEventListener("pointerout",u),r.addEventListener("focusin",d),r.addEventListener("focusout",p),r.addEventListener("keydown",it),()=>{clearTimeout($),r.removeEventListener("pointerover",l),r.removeEventListener("pointerout",u),r.removeEventListener("focusin",d),r.removeEventListener("focusout",p),r.removeEventListener("keydown",it),c.hidePopover(),c.remove(),g.current=void 0}},[o,i,v]),J(()=>{!o||!g.current||ht(g.current,n,s)},[n,s,o])},ee=k`
	:host {
...
`,oe=t=>{const{heading:e,description:o,for:n,placement:s="top",delay:i=300}=t,v=X(),g=X(),r=ut(()=>{clearTimeout(g.current),g.current=window.setTimeout(()=>{v.current?.showPopover()},i)},[i]),y=ut(()=>{clearTimeout(g.current),v.current?.hidePopover()},[]);return J(()=>{if(n)return;const c=b=>{const w=b.relatedTarget;w&&t.contains(w)||y()};return t.addEventListener("pointerover",r),t.addEventListener("pointerout",c),()=>{t.removeEventListener("pointerover",r),t.removeEventListener("pointerout",c)}},[n,r,y]),te(t,{for:n,heading:e,description:o,placement:s,delay:i}),n?q:a`
