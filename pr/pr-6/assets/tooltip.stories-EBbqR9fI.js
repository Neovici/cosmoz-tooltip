import{A as v,b as a,w as D,r as st,D as it}from"./iframe-DoDhZQqm.js";import"./preload-helper-PPVm8Dsz.js";const y=t=>t??v;function G(t,e,o){return t?e(t):o?.(t)}const rt=({slot:t,title:e,className:o,width:n="24",height:s="24",styles:i}={})=>a`
  <svg
    slot=${y(t)}
    class=${`delete-icon ${o??""}`}
    viewBox="0 0 24 24"
...
`,It=({title:t,description:e,for:o,placement:n="top",delay:s=300})=>{const i=q(),m=q(),p=I(()=>{clearTimeout(m.current),m.current=window.setTimeout(()=>{i.current?.showPopover()},s)},[s]),h=I(()=>{clearTimeout(m.current),i.current?.hidePopover()},[]),x=I(()=>o?i.current?.getRootNode()?.querySelector(`[name="${o}"]`):null,[o]);$t(()=>{if(!o)return;const r=x();if(r)return r.style.anchorName="--tooltip-anchor-external",r.addEventListener("mouseenter",p),r.addEventListener("mouseleave",h),r.addEventListener("focusin",p),r.addEventListener("focusout",h),()=>{r.removeEventListener("mouseenter",p),r.removeEventListener("mouseleave",h),r.removeEventListener("focusin",p),r.removeEventListener("focusout",h),r.style.anchorName=""}},[o,x,p,h]);const O=o?`position-area: ${n}; --tooltip-anchor-name: --tooltip-anchor-external;`:`position-area: ${n};`;return a`
		${o?v:a`
					<slot
						@mouseenter=${p}
						@mouseleave=${h}
  ...
  render: () => html\`
    ...
    \`
}`,...B.parameters?.docs?.source}}};const Qt=["Basic","TitleOnly","DescriptionOnly","ForAttribute","Placements","CustomDelay","CustomContent","OnLinks","OnIcons"];export{z as Basic,A as CustomContent,k as CustomDelay,S as DescriptionOnly,C as ForAttribute,B as OnIcons,L as OnLinks,T as Placements,E as TitleOnly,Qt as __namedExportsOrder,jt as default};
